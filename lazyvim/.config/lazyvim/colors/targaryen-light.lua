...
local function setup()
  ...
  vim.g.colors_name = "targaryen-light"
  ...
  h("DiffAdd",       { fg = c.wildfire, bg = "#d7ecdd" })
  h("DiffChange",    { fg = c.gold, bg = "#f7ecd2" })
  h("DiffDelete",    { fg = c.blood, bg = "#f8dcdd" })
  ...
  h("DiagnosticHint",             { fg = c.alt_violet })
  ...
  h("DiagnosticUnderlineHint",    { guisp = c.alt_violet, gui = "undercurl" })
  ...
  h("Constant",       { fg = c.alt_gold })
  h("String",         { fg = c.gold })
  h("Character",      { fg = c.alt_gold })
  ...
  h("@module",                { fg = c.alt_violet })
  h("@module.builtin",        { fg = c.violet })
  h("@namespace",             { fg = c.alt_violet })

  h("@symbol",                { fg = c.alt_glass })

  h("@string",                { link = "String" })
  h("@string.documentation",  { fg = c.gold, gui = "italic" })
  h("@string.regex",          { fg = c.alt_gold })
  h("@string.escape",         { fg = c.ember })
  h("@string.special",        { fg = c.alt_glass })
  h("@string.special.symbol", { fg = c.alt_glass })
  ...
  h("@type",                  { link = "Type" })
  h("@type.builtin",          { fg = c.alt_glass })
  h("@type.definition",       { fg = c.alt_violet, gui = "italic" })
  h("@type.qualifier",        { fg = c.violet })

  h("@attribute",             { fg = c.alt_gold })
  h("@property",              { fg = c.alt_steel })
  ...
  h("@punctuation.bracket",   { fg = c.alt_steel })
  h("@punctuation.special",   { fg = c.alt_glass })

  h("@variable",              { fg = fg })
  h("@variable.builtin",      { fg = c.dragonfire, gui = "italic" })
  h("@variable.member",       { fg = c.alt_steel })
  h("@variable.parameter",    { fg = c.alt_gold })
  h("@variable.parameter.builtin", { fg = c.gold })

  h("@field",                 { fg = c.alt_steel })
  ...
  h("@markup.heading.4",      { fg = c.alt_gold, gui = "bold" })
  ...
  h("@markup.link.label",     { fg = c.alt_glass })
  ...
  h("NvimTreeOpenedFolderName", { fg = c.alt_steel })
  ...
  h("NotifyTRACETitle",  { fg = c.alt_violet })
  ...
  h("NeoTreeGitUntracked", { fg = c.alt_violet })
