-- blue-matrix-light: a blue/cyan/teal light colorscheme for Neovim
-- Derived from the ghostty blue-matrix light theme palette.
...
-- Ghostty blue-matrix-light palette
local c = {
  black          = "#cedde6",
  pink           = "#c0266f",
  neon_green     = "#008f5a",
...
local function setup()
  ...
  vim.g.colors_name = "blue-matrix-light"
  ...
  h("DiffAdd",       { fg = c.neon_green, bg = "#dff8eb" })
  h("DiffChange",    { fg = c.gold, bg = "#c8d9e7" })
  h("DiffDelete",    { fg = c.light_pink, bg = "#ffe6ef" })
  h("DiffText",      { fg = bg, bg = c.med_blue })

  h("DiagnosticError",            { fg = "#b91c1c", gui = "italic" })
  h("DiagnosticWarn",             { fg = "#a16207", gui = "italic" })
  h("DiagnosticInfo",             { fg = c.bright_blue })
  h("DiagnosticHint",             { fg = c.light_lavender })
  h("DiagnosticOk",               { fg = c.neon_green })
  h("DiagnosticUnderlineError",   { guisp = "#b91c1c", gui = "undercurl" })
  h("DiagnosticUnderlineWarn",    { guisp = "#a16207", gui = "undercurl" })
  ...
  h("@comment.error",         { fg = "#b91c1c" })
  h("@comment.warning",       { fg = "#a16207" })
  ...
  h("@markup.raw.block",      { fg = c.neon_green, bg = "#d2dfe6" })
  ...
  h("NvimTreeGitDirty",    { fg = "#a16207" })
  h("NvimTreeGitNew",      { fg = c.neon_green })
  h("NvimTreeGitDeleted",  { fg = "#b91c1c" })
  ...
  h("NotifyERRORTitle",  { fg = "#b91c1c" })
  h("NotifyWARNTitle",   { fg = "#a16207" })
  ...
  h("NeoTreeGitModified", { fg = "#a16207" })
  h("NeoTreeGitDeleted",  { fg = "#b91c1c" })
